...
public class InternalGDSLParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_INT", "RULE_ID", "RULE_STRING", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'Grid'", "':'", "'-'", "'Rule:'", "'if'", "'cell'", "'is'", "'and'", "'neighbor'", "'then'", "'alive'", "'dead'", "'>'", "'<'", "'='", "'survive'", "'becomeAlive'", "'die'"
    };
    ...
    // InternalGDSL.g:472:1: ruleAction returns [Enumerator current=null] : ( (enumLiteral_0= 'survive' ) | (enumLiteral_1= 'becomeAlive' ) | (enumLiteral_2= 'die' ) ) ;
    public final Enumerator ruleAction() throws RecognitionException {
        ...
        try {
            // InternalGDSL.g:478:2: ( ( (enumLiteral_0= 'survive' ) | (enumLiteral_1= 'becomeAlive' ) | (enumLiteral_2= 'die' ) ) )
            // InternalGDSL.g:479:2: ( (enumLiteral_0= 'survive' ) | (enumLiteral_1= 'becomeAlive' ) | (enumLiteral_2= 'die' ) )
            {
            // InternalGDSL.g:479:2: ( (enumLiteral_0= 'survive' ) | (enumLiteral_1= 'becomeAlive' ) | (enumLiteral_2= 'die' ) )
            int alt7=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt7) {
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // InternalGDSL.g:496:3: (enumLiteral_2= 'die' )
                    {
                    // InternalGDSL.g:496:3: (enumLiteral_2= 'die' )
                    // InternalGDSL.g:497:4: enumLiteral_2= 'die'
                    {
